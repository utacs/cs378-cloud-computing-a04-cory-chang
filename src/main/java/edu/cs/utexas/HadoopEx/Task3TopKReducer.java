...
public class Task3TopKReducer extends  Reducer<Text, IntWritable, Text, IntWritable> {

    private PriorityQueue<Task2WordAndCount> pq = new PriorityQueue<Task2WordAndCount>(10);;
...
//    }
   ...
   public void reduce(Text key, Iterable<IntWritable> values, Context context)
       ...
       for (IntWritable value : values) {
           ...
           logger.info("Reducer Text: Add this item  " + new Task2WordAndCount(key, value).toString());

           pq.add(new Task2WordAndCount(new Text(key), new IntWritable(value.get()) ) );
    ...
    public void cleanup(Context context) throws IOException, InterruptedException {
        ...
        List<Task2WordAndCount> values = new ArrayList<Task2WordAndCount>(10);
